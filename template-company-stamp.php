...
<main id="main" class="site-main date-stamp company">
    <section class="section-hero-company-stamp">
        <div class="section-hero-company-stamp-wrapper">
        ...
        <div class="section-our-work-wrapper">
            ...
            <div class="section-our-work-description-wrapper">
                <div class="section-our-work-description-box-container">
                    ...
                    <?php
                    $slider_items = get_post_meta(get_the_ID(), 'slider_images_company_stamp', true);

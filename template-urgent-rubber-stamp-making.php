<?php
/**
 * Template Name: Urgent Rubber Stamp Making
...
$price_and_minimum_header = get_post_meta(get_the_ID(), 'price_and_minimum_header', true);
$price_and_minimum_detail_header_h3 = get_post_meta(get_the_ID(), 'price_and_minimum_detail_header_h3', true);
$price_and_minimum_detail_header_p = get_post_meta(get_the_ID(), 'price_and_minimum_detail_header_p', true);
$order_step_description_urgent = get_post_meta(get_the_ID(), 'order_step_description_urgent', true);
...
<main id="main" class="site-main each-stamp date-stamp urgent-stamp">
    <section class="section-hero-urgent-rubber-stamp">
        <div class="section-hero-urgent-rubber-stamp-wrapper">
            ...
            <div class="section-types-of-stamps-produce-detail-wrapper">
                ...
                <div class="section-types-of-stamps-produce-detail-box">
                    ...
                    <div class="section-types-of-stamps-produce-detail-text">
                        ...
                        <a href="<?php echo esc_url($types_of_stamps_produce_detail_text_bottom_link_2); ?>" class="section-types-of-stamps-produce-detail-text-bottom">
                            <p><u><?php echo esc_html($types_of_stamps_produce_detail_text_bottom_text); ?></u></p>
                            <div class="section-types-of-stamps-produce-detail-text-bottom-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/name-stamp/arrow_right_alt.png" alt="trayang-icon">
                            </div>
    ...
    <section class="section-price-and-minimum">
        <div class="section-price-and-minimum-wrapper">
            <div class="section-price-and-minimum-header">
                <h2><?php echo esc_html($price_and_minimum_header); ?></h2>
            </div>
            <div class="section-price-and-minimum-detail">
                <div class="section-price-and-minimum-detail-header">
                    <h3><?php echo esc_html($price_and_minimum_detail_header_h3); ?></h3>
                    <p><?php echo esc_html($price_and_minimum_detail_header_p); ?></p>
                </div>
            </div>
        </div>
    ...
    <section class="section-order">
        <div class="section-order-wrapper">
            <div class="section-order-header urgent-page">
            ...
            <div class="section-order-step-description-urgent">
                <p><?php echo esc_html($order_step_description_urgent); ?></p>
            </div>
        ...
        <div class="section-our-work-wrapper">
            ...
            <div class="section-our-work-description-wrapper">
                <div class="section-our-work-description-box-container">
                    ...
                    <?php
                    $slider_items = get_post_meta(get_the_ID(), 'slider_images_urgent_stamp', true);
    ...
    <section class="section-review">
        <div class="section-review-wrapper">
            ...
            <div class="section-review-description-wrapper-container">
                ...
                <?php $review_items = get_post_meta(get_the_ID(), 'review_group_urgent_stamp', true);

...
<main id="main" class="site-main date-stamp plastic">
    <section class="section-hero-plastic-stamp">
        <div class="section-hero-plastic-stamp-wrapper">
    ...
    <section class="section-date-stamp-second">
        <div class="section-dete-stamp-second-wrapper">
           <div class="section-dete-stamp-second-image-box wholesale-stamp">
        ...
        <div class="section-our-work-wrapper">
            ...
            <div class="section-our-work-description-wrapper">
                <div class="section-our-work-description-box-container">
                    ...
                    <?php
                    $slider_items = get_post_meta(get_the_ID(), 'slider_images_plastic_stamp', true);
